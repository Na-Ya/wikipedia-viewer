...
$("#submit-button").click(function submitForm() {
  ...
  $.ajax({  
    url: "https://en.wikipedia.org/w/api.php?action=query&format=json&prop=extracts&generator=search&exsentences=1&exlimit=max&exintro=1&explaintext=1&gsrsearch=" + encodeURIComponent(keyword),
    dataType: "jsonp",
  ...
  $("#resultsbox").append("<div class ='divlink'>" +"<h3>"+ titles +"</h3>" + "<p>"+ extracts + "</p>" +"<a href= 'https://en.wikipedia.org/?curid=" +curid +"'>" + "</a>" +"</div>");
        //console.log(curid);
